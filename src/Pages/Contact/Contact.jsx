        ...
        <div className="pt-20 md:pt-10">
            <div className="px-10 lg:px-20 ">
                ...
                <div className="flex flex-col md:flex-rowjustify-center items-center space-x-10 py-10">
                    <p className='text-black font-bold flex  items-center space-x-2 text-xl'><FaPhone></FaPhone> Phone:<span className='text-gray-500 font-normal'>+8801568173847</span></p>
                    <p className='text-black font-bold flex items-center space-x-2 text-xl'><SiGmail></SiGmail> Email:<span className='text-gray-500 font-normal'>mdnirab999@gmail.com</span></p>
                ...
                <form className="space-y-5" ref={form} onSubmit={sendEmail}>
                    ...
                    <input type="text" name="reply_to" placeholder="Email" className="input input-bordered rounded-none input-md w-full bg-[#f8f8f8]" />
